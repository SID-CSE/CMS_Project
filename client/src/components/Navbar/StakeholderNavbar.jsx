...
const quickLinks = [
  { label: "Home", description: "Approved content overview", to: "/stakeholder/home" },
  { label: "Project view", description: "Open project approvals", to: "/stakeholder/projects/pj-101" },
  { label: "Content viewer", description: "Read-only content preview", to: "/stakeholder/content/ct-501" },
  { label: "Notifications", description: "Approval-ready alerts", to: "/stakeholder/notifications" },
  { label: "Messages", description: "Open approval conversations", to: "/stakeholder/messages" },
  { label: "Profile", description: "Manage your stakeholder profile", to: "/stakeholder/profile" },
  { label: "Finance", description: "Pay requests and invoices", to: "/stakeholder/finance" },
  { label: "Content library", description: "Browse approved items", to: "/stakeholder/content" },
  { label: "Streaming", description: "Open live stream preview", to: "/stakeholder/streaming" },
];
    ...
    >
      <div className="flex h-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Stakeholder portal</p>
          </div>
        </div>
        ...
        <div className="relative hidden w-full max-w-xl lg:block">
          <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2.5 shadow-sm">
            ...
            <input
              ...
              placeholder="Search reports, content, approvals..."
        ...
        >
          ...
          <div className="hidden sm:block">
            <p className="text-sm font-semibold text-slate-900">Stakeholder</p>
      ...
      {profileOpen && (
        <div className="absolute right-4 top-[calc(100%+10px)] w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/home")}
          ...
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/projects/pj-101")}
            className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            Project view
          </button>
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/content")}
            className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            View content
          </button>
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/messages")}
            className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            Messages
          </button>
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/profile")}
            className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            Profile
          </button>
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/finance")}
            className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            Finance
          </button>
          <button
            type="button"
            onClick={() => handleNavigate("/stakeholder/streaming")}
            className="block w-full px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            Streaming
          </button>
