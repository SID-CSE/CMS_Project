    ...
    <div class="grid min-h-screen lg:grid-cols-[280px_1fr]">
        ...
        <main class="p-6 lg:p-10">
            <div class="mb-6 flex items-start justify-between gap-4">
                ...
                <a href="/projects" class="rounded-xl border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-white">Back to Projects</a>
            </div>
                    ...
                    <?php foreach ($tasks as $task): ?>
                        <article class="rounded-2xl border border-slate-200 p-4">
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                ...
                                <a href="/content/<?= urlencode($task->id) ?>/versions" class="rounded-lg border border-slate-300 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50">Version History</a>
                            </div>
