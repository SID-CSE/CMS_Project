...
$activePath = '/stakeholder/notifications';
?>
...
<div class="min-h-screen bg-slate-100 text-slate-900">
    <?php require_once __DIR__ . '/../partials/role-sidebar.php'; ?>
            ...
            <aside aria-label="Notification actions" class="space-y-6">
                <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    <h3 class="text-lg font-semibold text-slate-900">Quick Actions</h3>
                    <div class="mt-4 flex flex-wrap gap-3">
                        <a href="/stakeholder/messages/compose" class="rounded-xl bg-[#1734a1] px-4 py-3 text-sm font-semibold text-white hover:bg-[#132b86]">Compose Message</a>
                        <a href="/stakeholder/notifications/read-all" class="rounded-xl border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-white">Mark All Read</a>
                    </div>
                </div>
