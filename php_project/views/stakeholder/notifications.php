            ...
            <aside class="space-y-6">
                <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    ...
                    <div class="mt-4 flex flex-wrap gap-3">
                        <a href="/messages/compose" class="rounded-xl bg-[#1734a1] px-4 py-3 text-sm font-semibold text-white hover:bg-[#132b86]">Compose Message</a>
                        <a href="/notifications/read-all" class="rounded-xl border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-white">Mark All Read</a>
                    </div>
                </div>
