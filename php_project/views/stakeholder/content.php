...
<div class="min-h-screen bg-slate-100 text-slate-900">
    <div class="mx-auto max-w-6xl p-6 lg:p-10">
        <div class="mb-6 flex items-start justify-between gap-4">
            ...
            <a href="/stakeholder/home" class="rounded-xl border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-white">Back to Home</a>
        </div>
            ...
            <?php foreach ($projects as $project): ?>
                ...
                <section class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    <div class="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            <h3 class="text-xl font-semibold text-slate-900"><a class="hover:text-[#1734a1]" href="/stakeholder/content/<?= urlencode($project->id) ?>"><span><?= htmlspecialchars($project->title, ENT_QUOTES, 'UTF-8') ?></span></a></h3>
                        ...
                        <?php foreach ($projectTasks as $task): ?>
                            <article class="rounded-2xl border border-slate-200 p-4">
                                ...
                                <div class="mt-4 flex flex-wrap gap-2">
                                    ...
                                    <a href="/messages/compose" class="rounded-lg border border-slate-300 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50">Discuss</a>
                                </div>
