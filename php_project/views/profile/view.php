...
$avatarUrl = trim((string) ($profile['avatarUrl'] ?? $user['avatarUrl'] ?? ''));
            ...
            <section class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-4">
                        <div class="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border text-xl font-semibold <?= $accentClass ?>">
                            <?php if ($avatarUrl !== ''): ?>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">Display name: <?= htmlspecialchars($displayName, ENT_QUOTES, 'UTF-8') ?></p>
